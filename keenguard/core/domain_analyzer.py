...
TV_BRAND_PRESETS: Dict[str, Dict[str, Any]] = {
    "tv_lg": {
        ...
        "domains": [
            ...
            {"domain": "smartshare.lgtvsdp.com", "name": "LG SDP Platform", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "LG SDP Platform (фоновая телеметрия сервисов)", "impact": "Останавливает сбор облачной статистики платформы SDP. Локальный просмотр фильмов по DLNA/SmartShare с ПК/роутера не затрагивается (работает по L2 напрямую).", "troubleshoot": "Если возникают сбои отображения значков в облачном каталоге сервисов LG — разблокируйте."},
            ...
            {"domain": "rdx2.lgtvsdp.com", "name": "LG Live Plus (ACR)", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Рекомендуется заблокировать", "description": "LG Live Plus / ACR (распознавание контента)", "impact": "Отключает фоновую слежку за тем, что вы смотрите (анализ звуковых и видео-отпечатков передач даже с HDMI/антенны). Воспроизведение эфира и любых видео не нарушается.", "troubleshoot": "Побочных эффектов для воспроизведения контента нет. Разблокировка не требуется."},
            {"domain": "ad.lgappstv.com", "name": "LG Content Store Ads", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "LG Content Store Ads (реклама в каталоге)", "impact": "Убирает спонсорские рекламные блоки внутри магазина приложений LG. Побочных эффектов нет.", "troubleshoot": "Разблокировка не требуется."},
    ...
    "tv_samsung": {
        ...
        "domains": [
            {"domain": "samsungacr.com", "name": "Samsung ACR Engine", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Рекомендуется заблокировать", "description": "Samsung ACR (распознавание эфира и передач в реальном времени)", "impact": "Отключает распознавание контента ACR. Воспроизведение ТВ, кинотеатров и видео не нарушается.", "troubleshoot": "Побочных эффектов нет, разблокировка не требуется."},
            {"domain": "samsungads.com", "name": "Samsung Ads", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Платформа таргетированной рекламы Samsung Ads", "impact": "Убирает таргетированные рекламные баннеры на панели Smart Hub.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "samsungcloudplatform.com", "name": "Samsung Cloud Platform", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Облачная телеметрия сервисов платформы Samsung", "impact": "Блокирует фоновую облачную телеметрию сервисов Samsung.", "troubleshoot": "Если требуется вход в Samsung Account для синхронизации галереи — разблокируйте."},
            {"domain": "log-config.samsungcloud.com", "name": "Samsung Log Config", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Динамическая конфигурация сбора логов Samsung", "impact": "Останавливает получение новых правил логирования.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "config.samsungcloud.com", "name": "Samsung Config", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Удаленная настройка параметров трекинга", "impact": "Блокирует удаленную настройку параметров трекинга Tizen.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "samsungcloudsolution.com", "name": "Samsung Cloud Solution", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Сбор телеметрии и диагностических данных", "impact": "Предотвращает передачу диагностических данных Tizen.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "samsungqbe.com", "name": "Samsung QBE Diagnostics", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Диагностические логи ошибок и сбоев Tizen", "impact": "Блокирует отправку логов ошибок системных приложений.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "gpm.samsungqbe.com", "name": "Samsung QBE Metrics", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Samsung QBE Metrics (метрики системных процессов)", "impact": "Блокирует телеметрию системных процессов и производительности.", "troubleshoot": "Разблокировка не требуется."},
        ]
    },
    "tv_android_google": {
        ...
        "domains": [
            {"domain": "adservice.google.com", "name": "Google AdService", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Сервис рекламы и спонсорского промо на главном экране", "impact": "Блокирует спонсорские рекламные баннеры на домашнем экране Android/Google TV.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "pagead2.googlesyndication.com", "name": "Google AdSense", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Баннерная реклама Google AdSense в приложениях", "impact": "Блокирует всплывающую рекламу Google в сторонних ТВ-приложениях.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "google-analytics.com", "name": "Google Analytics", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Google Analytics для Smart TV", "impact": "Останавливает отправку телеметрии использования ТВ в Google Analytics.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "firebaselogging.googleapis.com", "name": "Firebase Logging", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Диагностическое логирование Firebase", "impact": "Блокирует фоновые логи диагностической платформы Firebase.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "app-measurement.com", "name": "App Measurement", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Трекинг событий и аналитика мобильных приложений ТВ", "impact": "Блокирует сбор данных о событиях внутри приложений.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "doubleclick.net", "name": "Google DoubleClick", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Глобальная сеть показа баннеров Google", "impact": "Блокирует показ рекламы глобальной сети DoubleClick.", "troubleshoot": "Разблокировка не требуется."},
        ]
    },
    "tv_xiaomi": {
        "id": "tv_xiaomi",
        ...
        "domains": [
            {"domain": "ad.xiaomi.com", "name": "Xiaomi PatchWall Ads", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Рекламные карточки и промо в оболочке PatchWall", "impact": "Убирает навязчивые рекламные карточки и промо-баннеры в оболочке PatchWall.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "tracking.miui.com", "name": "MIUI TV Tracking", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Сбор телеметрии оболочки PatchWall / MIUI TV", "impact": "Блокирует отправку телеметрии оболочки MIUI TV.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "data.mistat.xiaomi.com", "name": "MiStat Analytics", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Статистика кликов и использования приложений MiStat", "impact": "Останавливает отправку статистики кликов и запусков приложений MiStat.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "api.ad.xiaomi.com", "name": "Xiaomi Ad Engine", "category": "advertising", "risk": "ad", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "API персонализированной рекламы Xiaomi", "impact": "Блокирует API персонализированных рекламных объявлений Xiaomi.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "o2o.api.xiaomi.com", "name": "Xiaomi O2O Recommendations", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Сервер товарных рекомендаций и таргетинга Xiaomi", "impact": "Останавливает подгрузку коммерческих товарных рекомендаций Xiaomi.", "troubleshoot": "Разблокировка не требуется."},
        ]
    },
    "tv_apple": {
        "id": "tv_apple",
        ...
        "domains": [
            {"domain": "metrics.apple.com", "name": "Apple Diagnostics Metrics", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Системная диагностическая телеметрия Apple", "impact": "Останавливает отправку диагностических метрик tvOS. AirPlay и стриминг работают без ограничений.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "notes-analytics-events.apple.com", "name": "Apple Analytics Events", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Сбор событий аналитики и взаимодействий", "impact": "Блокирует сбор событий пользовательских взаимодействий в tvOS.", "troubleshoot": "Разблокировка не требуется."},
            {"domain": "xp.apple.com", "name": "Apple App Store XP", "category": "telemetry", "risk": "telemetry", "safety": "safe", "safety_label": "Безопасно блокировать", "description": "Аналитика переходов и покупок в App Store", "impact": "Останавливает аналитику переходов и покупок в App Store.", "troubleshoot": "Если при оформлении покупок в tvOS возникает сбой — разблокируйте этот домен."},
        ]
    }
}
    ...
    for preset_id, preset in TV_BRAND_PRESETS.items():
        ...
        for item in preset["domains"]:
            ...
            enriched_domains.append({
                ...
                "risk": item["risk"],
                "safety": safety,
                "safety_label": item.get("safety_label", "Безопасно блокировать"),
